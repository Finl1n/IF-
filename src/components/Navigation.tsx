...
import { Menu, Home, GraduationCap, BookOpen, Heart, Mail, ShoppingBag } from 'lucide-react'; // Importe o ícone ShoppingBag
...
              <NavLink icon={<Heart size={18} />} text="Doações" href="/doacoes" />
              <NavLink icon={<ShoppingBag size={18} />} text="Loja" href="https://www.lorimagias.com.br/" /> {/* Novo link para a loja */}
...
            <MobileNavLink text="Doações" href="/doacoes" />
              <MobileNavLink text="Loja" href="https://www.lorimagias.com.br/" /> {/* Novo link para a loja no mobile */}
